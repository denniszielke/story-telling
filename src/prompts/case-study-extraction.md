...
## 1. Scenario Description and Customer Context
Describe the initial situation, including:
- Industry and business domain
- Core business challenge or limitation
- Data, process, or operational constraints
- Scale, complexity, or performance context (if available)
- Why the problem was relevant or urgent

Focus on **problem framing and business context**, not the solution.

---

## 2. Approach and Architecture Concept Applied
